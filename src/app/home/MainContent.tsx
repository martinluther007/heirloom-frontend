...
const AssetCard = ({
  ...
  <div className="home__assetbox">
    <div className="home__assetcontainer">
      {icon}
      <div>
        <h3>{asset}</h3>
        <p className="text__main">Brief explanation of the above</p>
      </div>
    </div>

    <p className="asset__info">
      <span className="asset__info asset__info--sub">{numOfAssets}</span>
      Assets
    </p>
  </div>
);
...
const MainContent = () => {
  ...
  return (
    <div className="home__main">
      <div className="home__main--introbox">
        <div>
        ...
        <button className="success__link button__logout">
          Invite A Lawyer
        </button>
      </div>

      <div className="home__assetContain">
        <div className="home__assetChartbox">
          <h2 className="heading__main">My Portfolio</h2>

          <Doughnut data={data} options={options} />
        </div>
        <div className="home__chartdets">
          <h2 className="heading__main">breakdown</h2>

          <div className="home__assetdisplay">
            {assetData.map(({ icon, asset, assetNumber }, index) => (
              <AssetCard
                icon={icon}
                asset={asset}
                key={index}
                numOfAssets={assetNumber}
              />
            ))}
          </div>
        </div>
